...
import static com.example.nsapplication.EventInventory.CalendarUtils.daysInWeekArray;
...
public class WeekView_Calendar_Activity extends AppCompatActivity implements CalendarAdapter.OnItemListener
{
    ...
    private void initWidgets()
    {
        ...
        listView_event = findViewById(R.id.listView_event);
    }
    ...
    public void addEventAction(View view) {
        Intent intent = new Intent(WeekView_Calendar_Activity.this, EventEdit_Activity.class);
